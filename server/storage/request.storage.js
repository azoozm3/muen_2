...
import { buildNewEmergencyRequest, buildPatientRequestQuery, buildPrimaryResponderUpdate, buildRequestLocationUpdate, buildResponderLocationUpdate, buildStatusUpdate } from "./helpers/requestStorageHelpers.js";

export const requestStorageMethods = {
  async getRequests() {
